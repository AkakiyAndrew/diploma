...
int main(void)
{
    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        if (needsReset)
        {
            ...
            circle = CreatePhysicsBodyCircle((Vector2) { screenWidth / 2, screenHeight / 2 }, 45, 1);
        ...
        else if (IsMouseButtonPressed(MOUSE_RIGHT_BUTTON)) CreatePhysicsBodyPolygon(GetMousePosition(), GetRandomValue(10, 45), 3, 10);
